...
```{r}
# read data
budget_2011 <- read_csv("./input/source/budget/Budget_-_2011_Budget_Ordinance_-_Positions_and_Salaries.csv") %>% mutate(YEAR = 2011)
budget_2012 <- read_csv("./input/source/budget/Budget_-_2012_Budget_Ordinance_-_Positions_and_Salaries.csv") %>% mutate(YEAR = 2012)
budget_2013 <- read_csv("./input/source/budget/Budget_-_2013_Budget_Ordinance_-_Positions_and_Salaries.csv") %>% mutate(YEAR = 2013)
budget_2014 <- read_csv("./input/source/budget/Budget_-_2014_Budget_Ordinance_-_Positions_and_Salaries.csv") %>% mutate(YEAR = 2014)
budget_2015 <- read_csv("./input/source/budget/Budget_-_2015_Budget_Ordinance_-_Positions_and_Salaries.csv") %>% mutate(YEAR = 2015)
budget_2016 <- read_csv("./input/source/budget/Budget_-_2016_Budget_Ordinance_-_Positions_and_Salaries.csv") %>% mutate(YEAR = 2016)
budget_2017 <- read_csv("./input/source/budget/Budget_-_2017_Budget_Ordinance_-_Positions_and_Salaries.csv") %>% mutate(YEAR = 2017)
budget_2018 <- read_csv("./input/source/budget/Budget_-_2018_Budget_Ordinance_-_Positions_and_Salaries.csv") %>% mutate(YEAR = 2018)
budget_2019 <- read_csv("./input/source/budget/Budget_-_2019_Budget_Ordinance_-_Positions_and_Salaries.csv") %>% mutate(YEAR = 2019)
```
...
# make department names consistent
  ...
  DepartmentNameMap <- read.csv("./input/source/budget/Department Mapping Table.csv",stringsAsFactors = F)
...
```{r}
 # make job titles consistent
  ## load the mapping table
 JobTitleMap <- read_csv("./input/source/budget/Job Title Mapping Table.csv")
